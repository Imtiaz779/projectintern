      ...
      <div className="primary-container">
        ...
        <div className="flex justify-between items-center mb-16">
          ...
          <div className="hidden md:flex gap-4 ">
            <button onClick={handlePrevSlide} className="p-4 hover:bg-gray-300 rounded-full transition-colors">
              <HiArrowLeft />
            </button>
            <button onClick={handleNextSlide} className="p-4 hover:bg-gray-300 rounded-full transition-colors">
              <HiArrowRight />
            </button>
          </div>
        </div>
