    ...
    <div className="overflow-hidden py-24 bg-black text-white">
      <div className="primary-container">
        ...
        <div className="max-w-[50rem] lg:mb-24 mb-12">
          <h2 className="sm:text-5xl text-4xl md:text-7xl font-bold text-white mb-8 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col justify-between gap-16">
            ...
            <div>
               ...
               <Link className="inline-flex items-center px-8 py-4 bg-blue-500 text-white rounded-md hover:bg-blue-800 transition-colors mt-8">Get Started <span className="font-medium ml-1">it's free</span></Link>
